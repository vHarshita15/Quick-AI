...
const require_versionSelector = require('./versionSelector-A6nV1OJU.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	const version = require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.12.0");
